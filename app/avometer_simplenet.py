...
# Path definitions
paths = {
    'pipeline':os.path.join('model', 'export_old_model','pipeline.config'),
    'checkpoint': os.path.join('model','export_old_model','checkpoint', 'ckpt-0'), 
    'labelmap': os.path.join('model', 'export_old_model','label_map.pbtxt'), 
}
